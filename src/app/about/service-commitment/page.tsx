      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-green-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto fade-in">
            বাঘারপাড়া পৌরসভা প্রশাসনের পক্ষ থেকে জনগণের সেবায় আমাদের অঙ্গীকার
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              বাঘারপাড়া পৌরসভা প্রশাসন জনসাধারণের সেবায় নিবেদিত। আমরা প্রতিশ্রুতিবদ্ধ যে আমাদের সকল সেবা 
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    পৌরসভা কার্যালয়ে সরাসরি অভিযোগ দাখিল করতে পারেন
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8">
              <p className="text-xl leading-relaxed">
                "বাঘারপাড়া পৌরসভা প্রশাসন জনগণের সেবায় সর্বদা নিবেদিত। আমরা অঙ্গীকারবদ্ধ যে আমাদের 
