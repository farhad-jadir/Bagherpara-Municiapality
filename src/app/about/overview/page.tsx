  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      <footer className="bg-green-800 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4">বাঘারপাড়া উপজেলা</h3>
          <p className="text-green-200 mb-2">যশোর, খুলনা বিভাগ, বাংলাদেশ</p>
          <p className="text-green-300">© {new Date().getFullYear()} উপজেলা প্রশাসন, বাঘারপাড়া, যশোর</p>
        </div>
      </footer>
